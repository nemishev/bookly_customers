...
module.factory('dataSource', function($q, $http, $rootScope) {
  var ds = {
    customers : [],
    total     : 0,
    pages     : [],
    ...
    loadData  : function(params) {
      ...
      $http({
          method : 'POST',
          url    : ajaxurl,
          params : angular.extend({ action : 'ab_get_customers' }, params)
      })
...
module.controller('customersCtrl', function($scope, $http, dataSource) {
  // Set up initial data.
  var params = {
    page   : 1,
    sort   : 'name',
